...
fileinf.logger_name = 'TPA_CalibData_FLUXBOTtrunc';   % temperature file name
...
fileinf.end_date = ['8/1/2016 12:50'];                       % if datestr or datenum is given the evaluation will be restricted to all temperatures between start date and end date
...
% Thermal parameters
thermpar.rc = 2426720;          % volumetric heat capacity of of the saturated fluid solid system J/m³/K
thermpar.kfs = 2.92 %1.58;      % thermal condcuctivity of the saturated sediment W/m/k (saturated fluid solid system?!)
