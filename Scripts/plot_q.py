...
#inputs
fil ='C:\\SecondCreekGit\\SCRIPT OUTPUTS\\HEAD DIFFERENCES\\Scaled using PZStickup\\scaleddh1CW_shifted.csv' #path to dh series used in 1dtemp
K  = 0.02144#modeled from 1dtemp
...
title ='q at TPA modeled from shifted PZCW data' #plot title
